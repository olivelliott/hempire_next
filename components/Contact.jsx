  ...
  return (
    <div id="contact" className="max-w-[1240px] m-auto p-4 mb-0 lg:h-[100vh] grid content-center">
      <div className="relative">
        ...
        <div className="absolute inset-0 p-4 text-center my-24 md:my-12 lg:my-8">
          <h1 className="text-8xl md:text-6xl lg:text-8xl font-sans font-bold text-center p-4 text-white uppercase">
            connect with us
          </h1>
          ...
          <p className="text-6xl md:text-3xl lg:text-3xl mt-4 font-bold uppercase text-white font-sans">or</p>
          <a
            href="mailto:jkshaw13@gmail.com"
            className=" font-sans btn btn-lg md:btn-md lg:btn-md border-none relative ease-in duration-300 mt-8 text-3xl md:text-xl rounded bg-neutral active:bg-gray-800 text-white text-center active:text-gray-200"
          >
            send an email
          </a>
        </div>
